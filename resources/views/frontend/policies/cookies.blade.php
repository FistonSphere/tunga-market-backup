@extends('layouts.app')
@section('title', 'Cookies Policy - Tunga Market')
@section('content')
<section class="min-h-screen bg-gray-50 py-16 px-6">
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-10">
        ...
        <p class="text-gray-700 mb-6">
            Welcome to <strong>Tunga Market</strong>. This Cookies Policy explains how we use cookies and similar tracking technologies
            on our website <a href="https://tungamarket.com" class="text-blue-600 hover:underline">https://tungamarket.com</a>.
            Please read this policy carefully to understand how and why cookies are used and your rights regarding their control.
        </p>
        ...
        <ul class="list-disc pl-8 text-gray-700 space-y-2 mb-6">
            <li><strong>Strictly Necessary Cookies:</strong> Required for the website to function properly, such as authentication, session management, and security.</li>
            <li><strong>Performance Cookies:</strong> Help us understand how visitors use our site by collecting analytics and usage data (e.g., Google Analytics).</li>
            <li><strong>Functional Cookies:</strong> Remember user preferences, such as language, location, and saved settings.</li>
            <li><strong>Advertising & Targeting Cookies:</strong> Used to deliver relevant ads and measure marketing campaign performance.</li>
            <li><strong>Third-Party Cookies:</strong> Set by external platforms or services integrated into our site (e.g., social media logins, embedded content, or analytics tools).</li>
        </ul>
        ...
        <p class="text-gray-700 mb-6">
            We may use third-party tools such as <strong>Google Analytics, Meta Pixel,</strong> or <strong>Hotjar</strong>
            to collect data about your usage patterns. These services may use cookies to gather statistics about site activity.
        ...
        <p class="text-gray-700 mb-6">
            We may update this Cookies Policy from time to time to reflect changes in technology, law, or our business practices.
        ...
        <ul class="text-gray-700 pl-6">
            <li>Email: <a href="mailto:support@tungamarket.com" class="text-blue-600 hover:underline">support@tungamarket.com</a></li>

...
@section('content')
                                    ...
                                    <div class="wishlist-item border border-border rounded-lg p-4 hover:bg-surface transition-fast">
                                        <div class="flex items-center space-x-3">
                                            <img src="{{ asset($product->main_image ?? 'images/no-image.png') }}"
                                                alt="{{ $product->name }}" class="w-16 h-16 rounded-lg object-fill"
                                                loading="lazy" />
                                            <div class="flex-1">
    ...
    <script>
        ...
        function showNotify(type, message) {
            ...
            notify.className = `relative flex items-start space-x-3 ${styles[type].bg} text-white px-4 py-3 rounded-lg shadow-lg w-80 animate-slide-in hover:scale-105 transition transform duration-200`;

...
<section class="relative bg-gradient-to-br from-primary-50 to-accent-50 py-20">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-body-lg text-secondary-600 mb-8 max-w-3xl mx-auto">
            Get the support you need through our comprehensive communication hub. Whether you have sales inquiries, need technical assistance, or want to explore partnerships, we're ready to connect you with the right team.
        </p>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            <!-- Sales Inquiries -->
            <div class="card text-center group cursor-pointer hover:shadow-hover transition-all duration-300" onclick="selectContactType('sales')">
            ...
            <!-- Technical Support -->
            <div class="card text-center group cursor-pointer hover:shadow-hover transition-all duration-300" onclick="selectContactType('technical')">
            ...
            <!-- Partnerships -->
            <div class="card text-center group cursor-pointer hover:shadow-hover transition-all duration-300" onclick="selectContactType('partnerships')">
            ...
            <!-- Media Relations -->
            <div class="card text-center group cursor-pointer hover:shadow-hover transition-all duration-300" onclick="selectContactType('media')">
            ...
            <!-- General Questions -->
            <div class="card text-center group cursor-pointer hover:shadow-hover transition-all duration-300" onclick="selectContactType('general')">
                <div class="w-16 h-16 bg-secondary-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-secondary-200 transition-fast">
            ...
            <form id="contact-form" class="space-y-6">
                ...
                <div id="selected-contact-type" class="hidden bg-accent-50 border border-accent-200 rounded-lg p-4">
                    <div class="flex items-center space-x-3">
                        <div id="contact-type-icon" class="w-8 h-8 bg-accent-100 rounded-full flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-secondary-600" id="contact-type-description">Product inquiries, quotes, and bulk orders</div>
                        </div>
                        <button type="button" onclick="clearContactType()" class="ml-auto text-gray-400 hover:text-gray-600">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        <label for="first-name" class="block text-sm font-medium text-secondary-700 mb-2">First Name *</label>
                        <input type="text" id="first-name" name="first-name" required class="input-field" placeholder="Enter your first name" />
                    </div>
                    <div>
                        <label for="last-name" class="block text-sm font-medium text-secondary-700 mb-2">Last Name *</label>
                        <input type="text" id="last-name" name="last-name" required class="input-field" placeholder="Enter your last name" />
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        <label for="company" class="block text-sm font-medium text-secondary-700 mb-2">Company Name</label>
                        <input type="text" id="company" name="company" class="input-field" placeholder="Your Company Name" />
                    </div>
                    <div>
                        <label for="role" class="block text-sm font-medium text-secondary-700 mb-2">Your Role</label>
                ...
                <div>
                    ...
                    <input type="text" id="subject" name="subject" required class="input-field" placeholder="Brief description of your inquiry" />
                </div>

                <div>
                    <label for="message" class="block text-sm font-medium text-secondary-700 mb-2">Message *</label>
                    <textarea id="message" name="message" rows="6" required class="input-field resize-none" placeholder="Please provide detailed information about your inquiry. The more details you provide, the better we can assist you."></textarea>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-fast">
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-accent transition-fast cursor-pointer" id="file-drop-zone">
                        <svg class="w-8 h-8 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                        </svg>
                        <p class="text-sm text-gray-600 mb-1">Drop files here or <span class="text-accent font-semibold">browse</span></p>
                        <p class="text-xs text-gray-500">Max 10MB per file. Supports: PDF, DOC, DOCX, XLS, XLSX, PNG, JPG</p>
                        <input type="file" id="file-input" multiple accept=".pdf,.doc,.docx,.xls,.xlsx,.png,.jpg,.jpeg" class="hidden" />
                    </div>
                ...
                <div class="bg-primary-50 border border-primary-200 rounded-lg p-4">
                    <label class="flex items-center space-x-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-secondary-600">Our team will call you within 2 business hours</div>
                        </div>
                    </label>
                    ...
                    <div id="callback-details" class="hidden mt-4 space-y-3">
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                <label for="callback-time" class="block text-sm font-medium text-secondary-700 mb-1">Preferred Time</label>
                            ...
                            <div>
                                <label for="callback-timezone" class="block text-sm font-medium text-secondary-700 mb-1">Timezone</label>
                ...
                <div class="text-center">
                    <button type="submit" class="bg-gradient-to-r from-accent to-accent-600 hover:from-accent-600 hover:to-accent-700 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-card hover:shadow-hover">
                        Send Message
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="card text-center">
                ...
                <div class="space-y-3 text-sm">
                    <div>
                        ...
                        <a href="mailto:info@tungamarket.com" class="text-accent hover:text-accent-600">info@tungamarket.com</a>
                    </div>
                    <div>
                        <div class="font-medium text-secondary-700">Sales Team</div>
                        <a href="mailto:sales@tungamarket.com" class="text-accent hover:text-accent-600">sales@tungamarket.com</a>
                    </div>
                    <div>
                        <div class="font-medium text-secondary-700">Technical Support</div>
                        <a href="mailto:support@tungamarket.com" class="text-accent hover:text-accent-600">support@tungamarket.com</a>
                    </div>
                    <div>
                        <div class="font-medium text-secondary-700">Partnership</div>
                        <a href="mailto:partners@tungamarket.com" class="text-accent hover:text-accent-600">partners@tungamarket.com</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card text-center">
                ...
                <div class="space-y-3 text-sm">
                    <div>
                        ...
                        <a href="tel:+1-800-555-0123" class="text-success hover:text-success-600">+1 (800) 555-0123</a>
                        <div class="text-xs text-secondary-500">24/7 Available</div>
                    </div>
                    <div>
                        <div class="font-medium text-secondary-700">Europe</div>
                        <a href="tel:+44-20-7946-0958" class="text-success hover:text-success-600">+44 20 7946 0958</a>
                        <div class="text-xs text-secondary-500">9 AM - 6 PM GMT</div>
                    </div>
                    <div>
                        <div class="font-medium text-secondary-700">Asia Pacific</div>
                        <a href="tel:+86-400-123-4567" class="text-success hover:text-success-600">+86 400 123 4567</a>
            ...
            <div class="card text-center">
                ...
                <div class="space-y-3">
                    <button onclick="startLiveChat()" class="w-full bg-accent hover:bg-accent-600 text-white font-semibold py-2 px-4 rounded-lg transition-fast">
                        Start Chat Now
                    </button>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="card">
                ...
                <div class="mt-4 pt-4 border-t border-gray-200">
                    <button onclick="scheduleVisit('hq')" class="text-accent hover:text-accent-600 text-sm font-medium flex items-center space-x-1">
            ...
            <div class="card">
                ...
                <div class="mt-4 pt-4 border-t border-gray-200">
                    <button onclick="scheduleVisit('eu')" class="text-success hover:text-success-600 text-sm font-medium flex items-center space-x-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span>Schedule a Visit</span>
            ...
            <div class="card">
                ...
                <div class="mt-4 pt-4 border-t border-gray-200">
                    <button onclick="scheduleVisit('apac')" class="text-accent hover:text-accent-600 text-sm font-medium flex items-center space-x-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span>Schedule a Visit</span>
        ...
        <div class="mt-12 bg-white rounded-2xl shadow-modal p-8 text-center">
            ...
            <div class="bg-gray-100 rounded-lg h-64 flex items-center justify-center mb-4">
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Interactive map showing all office locations</p>
                    <p class="text-sm text-gray-500">Click on markers for detailed information</p>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="card text-center group cursor-pointer hover:bg-blue-50 transition-all duration-300">
                <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-200 transition-fast">
            ...
            <div class="card text-center group cursor-pointer hover:bg-green-50 transition-all duration-300">
                <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-green-200 transition-fast">
        ...
        <div class="grid lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-modal p-8">
                ...
                <div class="space-y-4 mb-6">
                    <div class="p-4 bg-error-50 rounded-lg">
                        ...
                        <a href="tel:+1-800-911-HELP" class="text-2xl font-bold text-error hover:text-error-600">+1 (800) 911-HELP</a>
                    ...
                    <div class="p-4 bg-warning-50 rounded-lg">
                        ...
                        <a href="mailto:emergency@tungamarket.com" class="text-lg font-semibold text-warning hover:text-warning-600">emergency@tungamarket.com</a>
                        <div class="text-sm text-secondary-600 mt-1">Response within 15 minutes</div>
                    </div>
                </div>

                <div class="text-sm text-secondary-600">
                    <strong>Emergency criteria:</strong> Service outages, payment failures, security breaches, or issues causing immediate business disruption.
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-modal p-8">
                ...
                <div class="mt-6 p-4 bg-accent-50 rounded-lg">
                    <div class="text-sm text-secondary-600">
                        <strong>Uptime SLA:</strong> 99.9% availability guarantee with automatic escalation procedures and compensation for downtime exceeding SLA thresholds.
                    </div>
                </div>
            </div>
        </div>

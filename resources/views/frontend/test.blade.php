                     ...
                     <div class="overflow-x-auto">
                         <table class="w-full">
                             ...
                             <tbody class="divide-y divide-border">
                                 ...
                                 <!-- Order Row 2 -->
                                 <tr class="order-row hover:bg-surface transition-fast cursor-pointer"
                                     data-status="shipped" data-date="2025-01-20"
                                     onclick="selectOrder('AM2025-456789')">
                                     <td class="px-4 py-4">
                                         <div class="flex items-center space-x-2">
             ...
             <div class="space-y-6">
                 ...
                 <div class="card">
                     ...
                     <div class="space-y-4">
                         <!-- Search Input -->
                         <div class="relative">
                             <input type="text" id="order-search" class="input-field pr-20"
                         ...
                         <div class="flex flex-wrap gap-2">
                             <button onclick="scanBarcode()"
                                 class="flex items-center space-x-2 px-3 py-2 border border-border rounded-lg hover:bg-surface transition-fast text-sm">

                    ...
                    @forelse($featuredDeals as $deal)
                        ...
                        <div class="carousel-item flex-shrink-0 w-80">
                            <div class="card group cursor-pointer hover:shadow-hover transition-all duration-300 relative overflow-hidden h-full"
                                ...
                                <!-- Discount Badge -->
                                <div class="absolute top-3 left-3 bg-accent text-white px-3 py-1 rounded-full text-xs font-bold z-10 animate-pulse">
                                    FEATURED {{ $deal->discount_percent }}% OFF
                                </div>

                                <!-- Urgency Badge -->
                                <div class="absolute top-3 right-3 bg-red-500 text-white px-2 py-1 rounded-full text-xs font-bold z-10">
                                    ENDING SOON
                                </div>

                                <!-- Product Image -->
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="{{ $deal->product->image_url ?? 'https://via.placeholder.com/300' }}"
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        <div class="flex items-center space-x-2">
                                            <span class="text-2xl font-bold text-accent">RWF {{ number_format($deal->flash_price) }}</span>
                                            <span class="text-sm text-gray-500 line-through">RWF {{ number_format($deal->product->price) }}</span>
                                        </div>

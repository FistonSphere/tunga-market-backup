    ...
    <section class="bg-surface py-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="flex items-center space-x-2 text-body-sm">
                ...
                <a href="product_discovery_hub.html" class="text-secondary-600 hover:text-primary transition-fast">Electronics</a>
                <svg class="w-4 h-4 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative bg-surface rounded-lg overflow-hidden">
                        <img id="mainImage" src="https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?q=80&w=2679&auto=format&fit=crop" alt="Premium Wireless Earbuds Pro" class="w-full h-96 object-cover" loading="lazy" onerror="this.src='https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
                        
                        <!-- AR Preview Button -->
                        <button class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full p-3 hover:bg-white transition-fast" title="AR Preview">
                        ...
                        <!-- Zoom Button -->
                        <button class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full p-3 hover:bg-white transition-fast" title="Zoom View">
                        ...
                        <!-- 360 View Button -->
                        <button class="absolute bottom-4 right-4 bg-accent text-white rounded-full p-3 hover:bg-accent-600 transition-fast" title="360° View">
                    ...
                    <div class="grid grid-cols-4 gap-2">
                        <button class="thumbnail-btn active rounded-lg overflow-hidden border-2 border-accent" onclick="changeMainImage(this, 'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?q=80&w=2679&auto=format&fit=crop')">
                            <img src="https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?q=80&w=2679&auto=format&fit=crop" alt="Main View" class="w-full h-20 object-cover" loading="lazy" />
                        </button>
                        <button class="thumbnail-btn rounded-lg overflow-hidden border-2 border-transparent hover:border-accent transition-fast" onclick="changeMainImage(this, 'https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')">
                            <img src="https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Side View" class="w-full h-20 object-cover" loading="lazy" />
                        </button>
                        <button class="thumbnail-btn rounded-lg overflow-hidden border-2 border-transparent hover:border-accent transition-fast" onclick="changeMainImage(this, 'https://images.unsplash.com/photo-1583394838336-acd977736f90?q=80&w=2684&auto=format&fit=crop')">
                            <img src="https://images.unsplash.com/photo-1583394838336-acd977736f90?q=80&w=2684&auto=format&fit=crop" alt="Case View" class="w-full h-20 object-cover" loading="lazy" onerror="this.src='https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
                        </button>
                        <button class="thumbnail-btn rounded-lg overflow-hidden border-2 border-transparent hover:border-accent transition-fast" onclick="changeMainImage(this, 'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?q=80&w=2832&auto=format&fit=crop')">
                            <img src="https://images.unsplash.com/photo-1590658268037-6bf12165a8df?q=80&w=2832&auto=format&fit=crop" alt="Detail View" class="w-full h-20 object-cover" loading="lazy" onerror="this.src='https://images.pixabay.com/photo/2017/05/10/19/29/robot-2301646_1280.jpg'; this.onerror=null;" />
                        </button>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="border border-border rounded-lg p-4">
                        <div class="flex items-baseline space-x-3 mb-3">
                            ...
                            <span class="bg-success text-white px-3 py-1 rounded-full text-body-sm font-semibold">25% OFF</span>
                        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <button class="w-full bg-warning text-white font-semibold px-6 py-3 rounded-lg hover:bg-warning-600 transition-fast">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-b border-border mb-8">
                <nav class="flex space-x-8">
                    <button class="tab-btn active py-4 px-1 border-b-2 border-accent font-semibold text-accent" onclick="showTab('specifications')">Specifications</button>
                    <button class="tab-btn py-4 px-1 border-b-2 border-transparent font-semibold text-secondary-600 hover:text-primary hover:border-secondary-300 transition-fast" onclick="showTab('reviews')">Reviews (2,847)</button>
                    <button class="tab-btn py-4 px-1 border-b-2 border-transparent font-semibold text-secondary-600 hover:text-primary hover:border-secondary-300 transition-fast" onclick="showTab('supplier')">Supplier Info</button>
                    <button class="tab-btn py-4 px-1 border-b-2 border-transparent font-semibold text-secondary-600 hover:text-primary hover:border-secondary-300 transition-fast" onclick="showTab('documentation')">Documentation</button>
                </nav>
            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="card">
                                <div class="flex items-start space-x-4">
                                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=2787&auto=format&fit=crop" alt="John D." class="w-12 h-12 rounded-full object-cover" loading="lazy" onerror="this.src='https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
                                    <div class="flex-1">
                                        ...
                                        <p class="text-body text-secondary-700 mb-3">
                                            "Absolutely amazing earbuds! The sound quality is incredible and the noise cancellation works perfectly. I use them daily for work calls and music. The battery life is exactly as advertised - I get a full week of use before needing to charge the case again."
                                        </p>
                                        <div class="flex items-center space-x-4 text-body-sm">
                                            <button class="text-secondary-600 hover:text-primary transition-fast">Helpful (23)</button>
                                            <button class="text-secondary-600 hover:text-primary transition-fast">Report</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="flex items-start space-x-4">
                                    <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?q=80&w=2787&auto=format&fit=crop" alt="Sarah M." class="w-12 h-12 rounded-full object-cover" loading="lazy" onerror="this.src='https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-2">
                                            <div>
                                        ...
                                        <p class="text-body text-secondary-700 mb-3">
                                            "Great earbuds for the price! The fit is comfortable for long periods and they stay in place during workouts. Love the water resistance feature. Only minor issue is that sometimes the connection drops if I'm too far from my phone, but overall very satisfied."
                                        </p>
                                        <div class="grid grid-cols-3 gap-2 mb-3">
                                            <img src="https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?q=80&w=2679&auto=format&fit=crop" alt="Review Photo 1" class="w-full h-20 object-cover rounded" loading="lazy" />
                                            <img src="https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Review Photo 2" class="w-full h-20 object-cover rounded" loading="lazy" />
                                            <img src="https://images.unsplash.com/photo-1583394838336-acd977736f90?q=80&w=2684&auto=format&fit=crop" alt="Review Photo 3" class="w-full h-20 object-cover rounded" loading="lazy" onerror="this.src='https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
                                        </div>
                                        <div class="flex items-center space-x-4 text-body-sm">
                                            <button class="text-secondary-600 hover:text-primary transition-fast">Helpful (15)</button>
                                            <button class="text-secondary-600 hover:text-primary transition-fast">Report</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="card">
                            <div class="flex items-start space-x-6 mb-6">
                                <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2940&auto=format&fit=crop" alt="TechSound Manufacturing" class="w-24 h-24 rounded-lg object-cover" loading="lazy" onerror="this.src='https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
                                <div class="flex-1">
                                    ...
                                    <div class="flex space-x-6">
                                        ...
                                        <div class="text-center">
                                            <div class="text-lg font-bold text-primary">< 2hrs</div>
                            ...
                            <div class="border-t border-border pt-6">
                                ...
                                <p class="text-body text-secondary-700 mb-4">
                                    TechSound Manufacturing is a leading audio equipment manufacturer specializing in premium wireless audio products. With over 8 years of experience, we serve global brands and have established ourselves as a trusted partner for high-quality consumer electronics.
                                </p>
                                ...
                                <div class="flex items-center justify-between p-3 bg-surface rounded-lg">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-body-sm text-secondary-600">Complete setup and usage guide</div>
                                        </div>
                                    </div>
                                    <button class="text-accent hover:text-accent-600 transition-fast">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h10a2 2 0 012 2v14a2 2 0 01-2 2z"/>
                                        </svg>
                                    </button>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-surface rounded-lg">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-body-sm text-secondary-600">Detailed technical datasheet</div>
                                        </div>
                                    </div>
                                    <button class="text-accent hover:text-accent-600 transition-fast">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex items-center justify-between p-3 bg-surface rounded-lg">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-body-sm text-secondary-600">CE, FCC, RoHS certificates</div>
                                        </div>
                                    </div>
                                    <button class="text-accent hover:text-accent-600 transition-fast">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="card">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="text-center p-4 bg-surface rounded-lg">
                                    <div class="w-16 h-16 mx-auto mb-3 bg-success-100 rounded-full flex items-center justify-center">
                                ...
                                <div class="text-center p-4 bg-surface rounded-lg">
                                    <div class="w-16 h-16 mx-auto mb-3 bg-accent-100 rounded-full flex items-center justify-center">
            ...
            <div class="card">
                ...
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea class="input-field resize-none" rows="4" placeholder="Please include any specific requirements, colors, customization needs, or other details..." required></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-border rounded-lg p-6 text-center">
                            <svg class="w-12 h-12 text-secondary-400 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="file" class="hidden" multiple accept=".pdf,.doc,.docx,.xls,.xlsx,.png,.jpg,.jpeg" />
                        </div>
                    </div>
                    
                    <div class="flex items-center space-x-3">
                        <input type="checkbox" id="terms" class="w-4 h-4 text-accent focus:ring-accent-500 border-border rounded" />
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="card group cursor-pointer hover:shadow-hover transition-all duration-300">
                    <div class="relative overflow-hidden rounded-lg mb-4">
                        <img src="https://images.unsplash.com/photo-1583394838336-acd977736f90?q=80&w=2684&auto=format&fit=crop" alt="Bluetooth Speaker" class="w-full h-48 object-cover group-hover:scale-105 transition-all duration-300" loading="lazy" onerror="this.src='https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
                ...
                <div class="card group cursor-pointer hover:shadow-hover transition-all duration-300">
                    <div class="relative overflow-hidden rounded-lg mb-4">
                        <img src="https://images.unsplash.com/photo-1590658268037-6bf12165a8df?q=80&w=2832&auto=format&fit=crop" alt="Noise Cancelling Headphones" class="w-full h-48 object-cover group-hover:scale-105 transition-all duration-300" loading="lazy" onerror="this.src='https://images.pixabay.com/photo/2017/05/10/19/29/robot-2301646_1280.jpg'; this.onerror=null;" />
                        <div class="absolute top-3 right-3 bg-white/90 backdrop-blur-sm rounded-full p-2">
                            <svg class="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                            </svg>
                ...
                <div class="card group cursor-pointer hover:shadow-hover transition-all duration-300">
                    <div class="relative overflow-hidden rounded-lg mb-4">
                        <img src="https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Smart Watch" class="w-full h-48 object-cover group-hover:scale-105 transition-all duration-300" loading="lazy" onerror="this.src='https://images.pixabay.com/photo/2017/05/10/19/29/robot-2301646_1280.jpg'; this.onerror=null;" />
                        <div class="absolute top-3 right-3 bg-white/90 backdrop-blur-sm rounded-full p-2">
                            <svg class="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                            </svg>
                ...
                <div class="card group cursor-pointer hover:shadow-hover transition-all duration-300">
                    <div class="relative overflow-hidden rounded-lg mb-4">
                        <img src="https://images.pixabay.com/photo/2017/05/10/19/29/robot-2301646_1280.jpg" alt="Phone Charging Stand" class="w-full h-48 object-cover group-hover:scale-105 transition-all duration-300" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2940&auto=format&fit=crop'; this.onerror=null;" />
                        <div class="absolute top-3 right-3 bg-white/90 backdrop-blur-sm rounded-full p-2">
                            <svg class="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                            </svg>

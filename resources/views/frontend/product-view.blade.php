    ...
    <section class="py-10 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap lg:flex-nowrap gap-6">
            ...
            <div class="flex-1 space-y-6 mt-4 mb-4">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-3" style="padding:15px;">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="mt-1 text-gray-500 text-sm">
                                    <span>MOQ: <strong class="text-gray-700">{{ $product->min_order_quantity }}</strong>
                                        pcs</span>
                                </div>
                            </div>
                ...
                @if ($product->features)
                    <div class="border border-gray-200 rounded-xl p-5 bg-gray-50" style="padding:15px">
        ...
        <div id="fullscreenModal" class="fixed inset-0 bg-black/90 hidden justify-center items-center z-[9999]">
            ...
            <button id="fsPrev" class="absolute left-6 bg-white/80 rounded-full p-3 hover:bg-white transition z-50">
                ◀
            </button>
            <button id="fsNext" class="absolute right-6 bg-white/80 rounded-full p-3 hover:bg-white transition z-50">
                ▶
            </button>
            ...
            <!-- Fullscreen Side Zoom Result (desktop) -->
            <div id="fsZoomResult"
                class="hidden absolute right-[-520px] top-0 w-[500px] h-[500px] border border-gray-300 rounded-lg overflow-hidden bg-white shadow-lg z-50">
            </div>
        </div>
            ...
            <div id="specifications" class="tab-content mt-10">
                ...
                @if (!empty($specifications))
                    <div id="specCardWrapper" class="relative">
                        ...
                        <!-- HEADER (visible in page, hidden in download) -->
                        <div class="spec-header flex justify-end px-6 py-4">
                            <button id="downloadSpecImage"
                                class="flex items-center gap-2 bg-accent text-white font-semibold px-4 py-2 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
                        ...
                        <div id="specCard"
                            ...
                            <!-- FOOTER (included in image, hidden on screen) -->
                            @php
                                $gs = \App\Models\GeneralSetting::first();
                            @endphp
                            <div
                                class="image-only-footer hidden-on-page bg-gray-50 flex justify-between items-center px-6 py-3 border-t border-gray-200">
                                <div class="flex items-center gap-2 text-sm text-gray-500">
                                    <img src="{{ $gs->logo }}" alt="Logo"
                                        class="w-6 h-6 rounded-full">
                                    <span>Generated by <strong>{{ $gs->site_name }}</strong></span>
                                </div>
                                <span class="text-xs text-gray-400">© {{ date('Y') }} {{ $gs->site_name }}. All Rights Reserved.</span>
                            </div>

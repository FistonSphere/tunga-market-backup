...
@section('content')
    ...
    <!-- 2FA Modal -->
    <div id="twoFaModal" class="fixed inset-0 bg-black bg-opacity-60 hidden flex justify-center items-center z-50">
        ...
        function open2FAModal() {
            ...
            fetch("{{ route('profile.2fa.generate') }}")
                ...
                .then(data => {
                    ...
                    // Insert QR code
                    document.getElementById('2fa-qrcode').innerHTML = data.qr;

                    ...
                    <div class="mt-6 p-4 bg-primary-50 rounded-lg">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-secondary-600 mb-2">Enable 2FA to protect your account with an extra
                                    layer of security.</p>
                                <button class="text-xs text-accent hover:text-accent-600 font-medium">Learn More →</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            ...
                            <label class="relative">
                                ...
                                <div
                                    class="p-3 text-center border-2 border-secondary-200 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:bg-primary-50 transition-fast">
                                    <div class="text-sm font-medium text-secondary-700 peer-checked:text-primary">Seller
                                    </div>
                                </div>
                            </label>
                            <label class="relative">
                    ...
                    <form class="space-y-4" onsubmit="handleSignUp(event)">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <label for="agreeTerms" class="text-sm text-secondary-600">
                                ...
                                <a href="#" class="text-accent hover:text-accent-600 font-medium">Privacy Policy</a>
                            </label>
                        </div>
                    ...
                    <div class="mt-6 p-4 bg-accent-50 rounded-lg">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-secondary-600">After registration, we'll guide you through profile
                                    setup, business verification, and finding your first suppliers.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="card text-center">
                    ...
                    <p class="text-body-sm text-secondary-600 mb-4">
                        Discover products and suppliers tailored to your business needs based on your browsing and purchase
                        history.
                    </p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-body-sm text-secondary-600">Optional 2FA with authenticator apps, SMS, or email
                                verification</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-body-sm text-secondary-600">Real-time monitoring of login attempts and unusual
                                account activity</p>
                        </div>
                    </div>

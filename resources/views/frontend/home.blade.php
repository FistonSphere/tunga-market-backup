                    ...
                    <div class="swiper-wrapper">
                        @forelse($successStories as $story)
                            <div class="swiper-slide">
                                <div class="group relative bg-white/80 backdrop-blur-lg border border-gray-100 rounded-2xl shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 ease-out p-8 text-center" style="margin-bottom:80px;">
                                    <div class="relative mb-6">
                                        ...
                                        <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-accent to-accent-600 text-white rounded-full p-1 shadow-md">

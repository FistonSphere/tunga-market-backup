...
<body class="bg-background text-text-primary">
    ...
    <div id="wishlist-overlay" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-modal max-w-2xl w-full max-h-screen overflow-hidden animate-fade-in">
            ...
            <div class="flex items-center justify-between p-6 border-b border-border">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-body-sm text-secondary-600"><span id="total-wishlist-count">12</span> items
                            saved</p>
                    </div>
                </div>
                ...
                <div id="wishlist-items" class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-primary mb-1 truncate">Premium Wireless Earbuds Pro</h3>
                            <p class="text-body-sm text-secondary-600 mb-2">TechSound Electronics</p>
                    ...
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-primary mb-1 truncate">Portable Bluetooth Speaker Pro</h3>
                            <p class="text-body-sm text-secondary-600 mb-2">AudioMax Solutions</p>
                    ...
                    <div
                        ...
                        <div class="relative flex-shrink-0">
                            ...
                            <div
                                class="absolute -top-1 -right-1 bg-warning text-white text-xs rounded-full px-1.5 py-0.5 font-semibold">
                                -15%
                            </div>
                        </div>

                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-primary mb-1 truncate">Smart Fitness Watch Pro</h3>
                            <p class="text-body-sm text-secondary-600 mb-2">HealthTech Innovations</p>

                            <div class="flex items-center space-x-4">
                                <div class="flex items-baseline space-x-2">
                                    <span class="text-lg font-bold text-primary">$129.99</span>
                                    <span class="text-body-sm text-secondary-500 line-through">$152.99</span>
                                </div>
                                <div class="flex items-center text-warning text-body-sm">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                    ...
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-primary mb-1 truncate">Noise Cancelling Headphones</h3>
                            <p class="text-body-sm text-secondary-600 mb-2">SoundPro Technologies</p>
                    ...
                    <div
                        ...
                        <div class="relative flex-shrink-0">
                            <img src="https://images.pixabay.com/photo/2017/05/10/19/29/robot-2301646_1280.jpg"
                                alt="Wireless Charging Pad" class="w-16 h-16 rounded-lg object-cover"
                                loading="lazy" />
                            <div
                                class="absolute -top-1 -right-1 bg-success text-white text-xs rounded-full px-1.5 py-0.5 font-semibold">
                                -33%
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-primary mb-1 truncate">Wireless Charging Pad Deluxe</h3>
                            <p class="text-body-sm text-secondary-600 mb-2">ChargeTech Solutions</p>
            ...
            <div class="border-t border-border p-6 bg-surface">
                <div class="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                    ...
                    <!-- See More Button -->
                    <button onclick="viewFullWishlist()" class="btn-primary flex items-center space-x-2 px-6 py-3">
                ...
                <div class="mt-6 pt-6 border-t border-border">
                    <h4 class="font-semibold text-primary mb-3">Recently Viewed</h4>
                    <div class="flex space-x-3 overflow-x-auto pb-2">
                        <div
                            class="flex-shrink-0 w-20 h-20 bg-secondary-100 rounded-lg flex items-center justify-center cursor-pointer hover:bg-secondary-200 transition-fast">
                            <img src="https://images.unsplash.com/photo-1484704849700-f032a568e944?q=80&w=2940&auto=format&fit=crop"
                                alt="USB-C Cable" class="w-16 h-16 rounded-lg object-cover" loading="lazy" />
                        </div>
                        <div
                            class="flex-shrink-0 w-20 h-20 bg-secondary-100 rounded-lg flex items-center justify-center cursor-pointer hover:bg-secondary-200 transition-fast">
                            <img src="https://images.pexels.com/photos/163100/circuit-circuit-board-resistor-computer-163100.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                                alt="Circuit Board" class="w-16 h-16 rounded-lg object-cover" loading="lazy" />
                        </div>
                        <div
                            class="flex-shrink-0 w-20 h-20 bg-secondary-100 rounded-lg flex items-center justify-center cursor-pointer hover:bg-secondary-200 transition-fast">
                            <img src="https://images.unsplash.com/photo-1498049794561-7780e7231661?q=80&w=2940&auto=format&fit=crop"
                                alt="Laptop" class="w-16 h-16 rounded-lg object-cover" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="mobile-bottom-nav" class="fixed bottom-0 left-0 right-0 bg-white border-t border-border md:hidden z-40">
        <div class="flex items-center justify-around py-2">
            ...
            <button onclick="window.location.href='product_discovery_hub.html'"
                class="flex flex-col items-center p-2 text-secondary-600 hover:text-primary transition-fast">
                <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
        ...
        <div class="bg-white shadow-modal rounded-lg p-4 border-l-4 border-success max-w-sm">
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-body-sm text-secondary-600 mt-1" id="toast-message">Action completed successfully.
                    </p>
                </div>
    ...
    <script>
        ...
        function closeWishlistPopup() {
            ...
            setTimeout(() => {
                window.location.href = document.referrer || 'homepage.html';
            }, 300);
        }
        ...
        function compareItems() {
            ...
            setTimeout(() => {
                window.location.href = 'product_discovery_hub.html';
            }, 1500);
        }

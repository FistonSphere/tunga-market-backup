        ...
        <div class="border border-secondary-200 rounded-lg p-6 hover:shadow-hover transition-fast">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <p class="text-secondary-600 text-sm">{{ $order->shippingAddress->address_line1 }}</p>
                    <p class="text-secondary-600 text-sm">
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        @if(in_array($order->status, ['processing', 'shipped']))
                            <button onclick="window.location.href='{{ route('orders.track', $order->id) }}'"
                        ...
                        <button onclick="reorderItems()" class="text-accent hover:text-accent-600 text-sm font-semibold">
                            Reorder
                        </button>
                    </div>
                </div>

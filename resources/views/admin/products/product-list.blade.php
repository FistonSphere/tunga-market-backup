                ...
                <table class="table datanew">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="{{ asset('admin/assets/img/product/product3.jpg') }}" alt="product" />
                                </a>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="{{asset('admin/assets/img/product/product4.jpg')}}" alt="product" />
                                </a>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="{{asset('admin/assets/img/product/product5.jpg')}}" alt="product" />
                                </a>

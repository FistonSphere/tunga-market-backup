...
@section('content')
    ...
    <div class="contact-management-container">
        ...
        <div class="header-bar d-flex align-items-center justify-content-between mb-4">
            ...
            <div>
                <form method="GET" action="{{ route('admin.support.contactRequests') }}" class="d-flex gap-2 mb-3">
                    ...
                    <a href="/admin/support/contact-requests" onclick="window.history.back()" class="btn btn-primary btn-sm"><i class="bi bi-funnel"></i> Reset</a>
                </form>
    ...
    <div id="replyModal" class="modal">
        <div class="modal-content">
            ...
            <div class="contact-summary">
                <h4><i class="bi bi-person-lines-fill"></i> Contact Summary</h4>
                ...
                <p style="overflow-wrap: anywhere;"><strong>Message:</strong> <span id="issueMessage">-</span></p>
            </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelectorAll(".view-contact").forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    document.getElementById("v_fullName").textContent = `${contact.first_name ?? ''} ${contact.last_name ?? ''}`.trim() || '-';
                    ...
                    if (Array.isArray(contact.attachments) && contact.attachments.length > 0) {
                        contact.attachments.forEach((file, index) => {
                            ...
                            a.href = file;
                            a.target = "_blank";
                            a.textContent = `Attachment ${index + 1}`;
                        ...
                        attachmentsContainer.innerHTML = "<p>No attachments uploaded.</p>";
                    }

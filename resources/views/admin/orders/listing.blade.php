    ...
    <div class="orders-dashboard">
        ...
        <div class="orders-header">
            <h1><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                </svg> Orders Management
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 16 16" fill="currentColor"
                    class="bi bi-app">
                    <!-- Square border icon -->
                    <path
                    ...
                    <!-- Add number in the middle -->
                    <text x="8" y="10" text-anchor="middle" fill="black" font-size="5" font-family="Arial, sans-serif">
                        {{ $orders->count() }}
                    </text>
                </svg>

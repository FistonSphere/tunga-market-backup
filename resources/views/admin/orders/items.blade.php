        ...
        <header class="order-header">
            <div class="order-summary-card">
                ...
                <div class="order-meta-grid">
                    ...
                    <div class="meta-card">
                        <svg style="color:#fd5e0e" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div style="display: flex; align-items: center; gap: 8px;">
                            ...
                            <button id="copyButton" onclick="copyTransactionId()"
                                ...
                                <svg style="color: orangered;display: none;" id="checkIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"

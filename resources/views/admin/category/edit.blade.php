...
<div class="edit-category-wrapper">
    ...
    <form action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data" class="category-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div class="form-left">
                ...
                <div class="form-card">
                    ...
                    <textarea name="description" id="description" rows="5" placeholder="Enter category description...">{{ old('description', $category->description) }}</textarea>
                </div>

...
Route::get('/listing', 'OrderListing')->name('admin.orders.list');
...
Route::put('/order-items/{item}/update', 'update')->name('order-items.update');
Route::delete('/order-items/{item}/delete', 'destroy')->name('order-items.destroy');
});
//end orders route

//delivery routes
Route::prefix('delivery')->controller(DeliveryTransportController::class)->group(function () {
...
//delivery routes
 //user management routes
    Route::prefix('users')->controller(AdminUserController::class)->group(function () {
        ...
        Route::post('/shipping-addresses/{id}',  'updateShipping')->name('admin.shipping.update');
 ...
 //contact request routes
    ...
    Route::get('/reports/purchase-orders', [AdminReportController::class, 'purchaseOrderReport'])->name('admin.reports.purchase_orders');
     Route::get('/reports/purchase-orders/export-pdf', [AdminReportController::class, 'exportPurchaseOrdersPDF'])->name('admin.reports.exportPurchaseOrdersPDF');
    //report routes
